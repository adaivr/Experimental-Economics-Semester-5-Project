...
# Убрать фиксированное количество игроков
# Подставить в формулу 
# Выбор вложения труд или капитал
# Страница результатов переписать
# Страницу итогов за все раунды по всем игрокам
# Сделать 10 периодов
# Кнопку далее после результатов
